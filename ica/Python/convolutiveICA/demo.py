...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 13 20:54:46 2020
...
#[[0.99999,0.9995]]  [0.999992,0.999] [0.99999,0.9999]
...
X =X_sim
[N,p]=X.shape
#[A_,S_,beta_,Y_] = FastICA_Decorreation(X,M=M,L=L,maxiters=400,choice='sup',tol=1e-12,ratios=[0.999995,0.9995])
[A_,S_,beta_,Y_] = FastICA_Decorreation4(X,M=M,L=L,maxiters=200,choice='sup',tol=1e-7,ratio=0.995)
...
plt.legend()
#fig = plt.gcf()
#fig.savefig("./3x3 deflation mode/observations.pdf")
...
plt.legend()
#fig = plt.gcf()
#fig.savefig("./3x3 deflation mode/sources.pdf")
...
plt.legend()
#fig = plt.gcf()
#fig.savefig("./3x3 deflation mode/innovation process.pdf")
...
plt.legend()
#fig = plt.gcf()
#fig.savefig("./3x3 deflation mode/recovered sources.pdf")